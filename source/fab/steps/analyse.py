...
from fab.util import TimerLogger, HashedFile, do_checksum, log_or_dot_finish, Artefacts, SourceGetter
...
class Analyse(Step):
    ...
    def run(self, artefacts, config):
        ...
        with TimerLogger("adding MO 'DEPENDS ON:' file dependency comments"):
